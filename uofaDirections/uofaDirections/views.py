...
def routeResponse(request):
    ...
    doors, N = generateJson("./uofaDirections/static/data/MapData-Buildings.csv")
    peds = getPedways('./uofaDirections/static/data/MapData-Pedways.csv')
    ...
    with open("./uofaDirections/static/data/ex_edges.json", "r+") as rf:
